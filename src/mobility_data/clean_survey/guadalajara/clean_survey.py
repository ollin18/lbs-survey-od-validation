...
data_dir = "/home/ollin/Dropbox/enlace_hacia_documentos/Berkeley/od_survey/data/raw/guadalajara/survey/viajes_5k_10k"
gdf = gpd.read_file(os.path.join(data_dir, "amg_lineas_deseo_5000_10000_numero_viajeLine.shp"))
gdf["tipo_de_vi"].value_counts()
print(list(gdf.columns))

gdf.rename(columns=names_dict, inplace=True)
gdf = gdf[["home_geomid", "work_geomid", "count"]]
gdf["count"] = gdf["count"].astype(int)
gdf["count"].sum()  # This yields 1,186,272 which is okay
