...
import pandas as pd
hour_dist = pd.read_csv("/global/home/users/ollin/test_cuebiq/informed_versions/ho_trips_by_hour.csv")
...
# ---------------------------
df_clean = spark.read.parquet(PARQUET_DIR_IN)
df_clean = df_clean.filter(col("location_type") != "W")
...
ax.set_title('Percentage of Home-based Other Trips by Hour of the Day', fontsize=22, fontweight='bold', pad=22)
