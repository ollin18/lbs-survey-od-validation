...
import pandas as pd
hour_dist = pd.read_csv("/global/home/users/ollin/test_cuebiq/informed_versions/nhb_trips_by_hour.csv")
...
ax.set_title('Percentage of Non-home-based Trips by Hour of the Day', fontsize=22, fontweight='bold', pad=22)
